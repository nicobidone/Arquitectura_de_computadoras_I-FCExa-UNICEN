...
HD_PWD='C:/Users/nicob/Google Drive/Arquitectura de sistemas I/Vivado/TPE_2017/TPE_2017.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log processor_tb.vds -m64 -mode batch -messageDb vivado.pb -notrace -source processor_tb.tcl
